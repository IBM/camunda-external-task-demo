 ...
 */
package org.camunda.bpm.getstarted.checkcard;
...
public class SimpleCheckCardWorker {
	private final static Logger LOGGER = Logger.getLogger(SimpleCheckCardWorker.class.getName());
...
//		final int CLIENT_NUMBER = System.getenv("CLIENT_NUMBER") != null ? Integer.parseInt(System.getenv("CLIENT_NUMBER")) : 3;
		...
		client.subscribe("check-card")
				.lockDuration(1000L * LOCK_DURATION) // the default lock duration is 20 seconds, but you can override this
